...
public class StockAdapter2 extends ListAdapter<Stock, StockAdapter2.MyViewHolder> {
    ...
    public StockAdapter2(Activity activity) {
        super(DIFF_UTIL);
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemLista = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_stock_2, parent, false);
    ...
    private void bindStock(Stock stock, StockAdapter2.MyViewHolder holder) {
